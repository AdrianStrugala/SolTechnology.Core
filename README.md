...
| [Jobs](https://github.com/AdrianStrugala/SolTechnology.Core/tree/master/docs/Jobs.md)                      | `Hangfire`, `Jobs`, `Retry`, `Background`           | <a href="https://www.nuget.org/packages/SolTechnology.Core.Jobs/"><img src="https://badgen.net/nuget/v/SolTechnology.Core.Jobs?icon=nuget&color=blue"></a>    |
