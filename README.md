...
| [API Testing](https://github.com/AdrianStrugala/SolTechnology.Core/tree/master/docs/Api.md#3-api-testing)  | `Testing`, `TestServer`, `Integration` | <a href="https://www.nuget.org/packages/SolTechnology.Core.Api.Testing/"><img src="https://badgen.net/nuget/v/SolTechnology.Core.Api.Testing?icon=nuget&color=blue"></a> |
