...
/// <summary>
/// Tests for the SQLite persistence layer — relocated from SolTechnology.Core.Story.Tests.
...
public class SQLiteRepositoryTests
{
    ...
    public async Task Repository_ShouldPersistAcrossInstances()
    {
        ...
        // Fresh repo instance on the same file — proves cross-instance durability
