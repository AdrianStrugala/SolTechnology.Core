...
{
    public class MichelinHTTPClient : IMichelinHTTPClient
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<MichelinHTTPClient> _logger;
        private readonly MichelinHTTPOptions _options;

        public MichelinHTTPClient(IOptions<MichelinHTTPOptions> options, HttpClient httpClient, ILogger<MichelinHTTPClient> logger)
        {
            _logger = logger;
