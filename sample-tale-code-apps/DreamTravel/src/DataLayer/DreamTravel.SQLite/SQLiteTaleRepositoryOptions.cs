...
/// <summary>
/// Configuration for <see cref="SQLiteTaleRepository"/>. Exposed so the registration
/// helper <c>UseSQLiteTaleRepository</c> can be called either with a connection string
/// shortcut or with a configure callback for fine-grained tuning.
/// </summary>
public sealed class SQLiteTaleRepositoryOptions
{
    /// <summary>
    /// ADO.NET connection string. Defaults to a file under
    /// <c>%LOCALAPPDATA%/SolTechnology/TaleFramework/stories.db</c>.
    ...
    private static string BuildDefaultConnectionString()
    {
        ...
        var directory = Path.Combine(appData, "SolTechnology", "TaleFramework");
