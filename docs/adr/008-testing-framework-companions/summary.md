...
| # | Title | File | Status |
|---|---|---|---|
| 01 | Run premortem (plan gate) | [`reviewed/01-run-premortem.md`](reviewed/01-run-premortem.md) | 🔍 reviewed |
| 02 | Foundation package `SolTechnology.Core.Testing` (+ container lifetime/reuse) | [`reviewed/02-core-testing-foundation.md`](reviewed/02-core-testing-foundation.md) | 🔍 reviewed |
