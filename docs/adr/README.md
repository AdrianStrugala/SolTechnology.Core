...
|---|---|---|---|
| 001 | [Acronym capitalization refactoring](001-acronym-capitalization-refactoring.md) | Accepted | ✅ Done |
| 002 | [Story Framework implementation](002-Story-Framework-Implementation.md) | Accepted | ✅ Done |
| 003 | [API versioning strategy](003-api-versioning-strategy.md) | Accepted | ✅ Done |
...
| 008 | [Testing framework `.Testing` companion packages](008-testing-framework-companions.md) | Accepted | 🔍 Implementing — 10/11 shipped; only [publish workflow](008-testing-framework-companions/reviewed/09-publish-workflow.md) left (see [summary](008-testing-framework-companions.md#implementation-summary)) |
...
- Recommended sections: Alternatives Considered, Stakeholders, Related.
