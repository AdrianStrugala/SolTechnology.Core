...
| 013 | [Release 1.0 — versioning, hard registration-API rename, Story→Tale rebrand, deprecations, publish hardening](013-release-1.0.md) | 2026-06-29 | Proposed | 🔍 Implementing — see [summary](013-release-1.0/summary.md) |
