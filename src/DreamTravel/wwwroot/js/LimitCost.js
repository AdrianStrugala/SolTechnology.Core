    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (var i = 0; i < noOfPaths; i++) {
                ...
                markers[i] = displayMarker(map, pathList[i].StartingCity.Latitude, pathList[i].StartingCity.Longitude, i);
            }
            ...
            markers[markers.length - 1] = displayMarker(map, pathList[noOfPaths - 1].EndingCity.Latitude, pathList[noOfPaths - 1].EndingCity.Longitude, noOfPaths);
...
//# sourceMappingURL=LimitCost.js.map